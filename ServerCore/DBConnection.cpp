...
{
	if (::SQLAllocHandle(SQL_HANDLE_DBC, henv, OUT &_connection) != SQL_SUCCESS)
		return false;
...
// private
bool DBConnection::BindParam(SQLUSMALLINT paramIndex, SQLUSMALLINT cType, SQLUSMALLINT sqlType, SQLULEN len, SQLPOINTER ptr, SQLLEN* index)
{
...
bool DBConnection::BindCol(SQLUSMALLINT columnIndex, SQLUSMALLINT cType, SQLULEN len, SQLPOINTER value, SQLLEN* index)
{
