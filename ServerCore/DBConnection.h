...
private:
	bool	BindParam(SQLUSMALLINT paramIndex, SQLUSMALLINT cType, SQLUSMALLINT sqlType, SQLULEN len, SQLPOINTER ptr, SQLLEN* index);
	bool	BindCol(SQLUSMALLINT columnIndex, SQLUSMALLINT cType, SQLULEN len, SQLPOINTER value, SQLLEN* index);
